...
/**
 * ──────────────────────────────────────────────────────────────
 *  SOCCER CITY — Design tokens
 *  Palette extraite du logo officiel :
 *  • Bleu électrique  #0357F3  (rgb 2,86,243 — mesuré sur le logo)
 *  • Noir profond     #050607
 *  • Blanc            #FCFCFC
 *  Le vert « créneau libre » est une couleur fonctionnelle (gazon).
 * ──────────────────────────────────────────────────────────────
 */
const config: Config = {
  darkMode: ["class"],
  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        primary: {
          DEFAULT: "hsl(var(--primary))", // #0357F3
        ...
        pitch: { DEFAULT: "#16C36A", dark: "#0E8A4B" }, // créneaux libres
      },
      fontFamily: {
        display: ["var(--font-display)", "sans-serif"], // Saira — titres, chiffres (italique sport)
        sans: ["var(--font-body)", "sans-serif"], // Archivo — texte courant
      },
      borderRadius: {
        lg: "var(--radius)",
